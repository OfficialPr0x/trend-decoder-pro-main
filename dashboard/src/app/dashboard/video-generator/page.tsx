...
export default function VideoGeneratorPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-5xl font-black text-white tracking-tight">Video Generator</h1>
      ...
      {/* Usage Stats */}
      <Card className="border-2 border-[#FF385C]/30 bg-gradient-to-br from-[#FF385C]/5 to-[#F97316]/5">
        <CardContent className="pt-6">
          <div className="flex items-center justify-between mb-3">
            <div className="text-base font-black text-white uppercase tracking-wide">Videos This Month</div>
            <div className="text-sm text-gray-400 font-bold">8 / 2 used</div>
          </div>
          <Progress value={(8 / 2) * 100} className="h-3 bg-white/10" />
          <p className="mt-3 text-sm text-[#FFB800] font-bold">
            You've exceeded your free tier limit. Upgrade to Pro for 50 videos/month.
          </p>
          <Button size="sm" className="mt-4 vibey-button font-black uppercase tracking-wide">
            Upgrade to Pro
          </Button>
        </CardContent>
      </Card>
            ...
            <CardContent className="space-y-4">
              {selectedTemplate ? (
                <>
                  ...
                  <Button className="w-full h-14 bg-gradient-to-r from-[#A855F7] to-[#7C3AED] hover:from-[#7C3AED] hover:to-[#A855F7] text-white font-black uppercase tracking-wide transition-all duration-200 shadow-lg shadow-[#A855F7]/40" size="lg" onClick={handleGenerate}>
