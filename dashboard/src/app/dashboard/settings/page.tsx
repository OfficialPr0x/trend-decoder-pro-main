  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-4 h-14 p-2 gap-2 bg-white/5 border border-white/10">
          <TabsTrigger value="account" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#A855F7] data-[state=active]:to-[#7C3AED] data-[state=active]:text-white font-bold">
            <User className="mr-2 h-4 w-4" />
            Account
          </TabsTrigger>
          <TabsTrigger value="billing" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#FF385C] data-[state=active]:to-[#F97316] data-[state=active]:text-white font-bold">
            <CreditCard className="mr-2 h-4 w-4" />
            Billing
          </TabsTrigger>
          <TabsTrigger value="usage" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#00D9FF] data-[state=active]:to-[#0099CC] data-[state=active]:text-white font-bold">
            <BarChart3 className="mr-2 h-4 w-4" />
            Usage
          </TabsTrigger>
          <TabsTrigger value="notifications" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#EC4899] data-[state=active]:to-[#DB2777] data-[state=active]:text-white font-bold">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {subscriptionTiers.slice(1).map((tier) => (
                  ...
                  >
                    ...
                    <Button className={`w-full h-12 font-black uppercase tracking-wide ${
                      tier.popular 
                        ? 'bg-gradient-to-r from-[#FF385C] to-[#F97316] hover:from-[#F97316] hover:to-[#FF385C] shadow-lg shadow-[#FF385C]/40' 
                        : 'bg-gradient-to-r from-[#A855F7] to-[#7C3AED] hover:from-[#7C3AED] hover:to-[#A855F7] shadow-lg shadow-[#A855F7]/40'
                    }`}>
